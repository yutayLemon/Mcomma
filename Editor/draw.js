...
function InitAssets(){
        ...
        let redoSymbole = LoadMoveToggle("./PNG/redo.png");//generated by chat GPT

        return Promise.all([MoveAssert,ExpandAssert,InterAsset,redoSymbole])
        .then(([objMove,objExpand,objInter,objRedo])=>{
            assets.move = objMove;
